<div class="col-md-12">
            <div class="card card-primary shadow-none">
              <div class="card-header">
                <h3 class="card-title">Tambah Gambar Produk : <?= $produk->nama_produk ?></h3>
                ...
                <div class="card-body">
                    ...
                    ?>
                    <?php echo form_open_multipart('gambarproduk/add/'.$produk->id_produk) ?>
                    ...
                    <div class="form-group">
                        ...
                        <a href="<?= base_url('gambarproduk') ?>" class="btn btn-success btn-sm">Kembali</a>
                    </div>
                    ...
                    <div class="row">
                        <?php foreach ($gambar as $key => $value) { ?>
                            <div class="col-sm-3">
                                <div class="form-group">
                                    <img src="<?= base_url('assets/gambarproduk/'.$value->gambar)?>" id="gambar_load" width="250px" height="200px">
                                </div>
                                <p for="">Ket : <?= $value->ket ?></p>
                                <button data-toggle="modal" data-target="#delete<?= $value->id_gambar ?>" class="btn btn-danger btn-xs btn-block"><i class="fas fa-trash">Delete</i></button>
                            </div>
                        <?php } ?>
                    </div>
