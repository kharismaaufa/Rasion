        ...
        <div class="register-box">
            ...
            <div class="card">
                ...
                echo form_open('pelanggan/register'); ?>
                    ...
                    <input type="text" name="nama_pelanggan" value="<?php set_value('nama_pelanggan') ?>" class="form-control" placeholder="Nama Pelanggan">
                    ...
                    <div class="input-group mb-3">
                    <input type="email" name="email" value="<?php set_value('email') ?>" class="form-control" placeholder="E-mail">
                        <div class="input-group-append">
                            <div class="input-group-text">
